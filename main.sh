...
if [[ "$DOWNLOAD" != "0" ]]; then
  rm -rf $src
  git clone --depth=1 --recursive https://github.com/wolfram77/$src -b graph-openmp
  cd $src
  git checkout graph-openmp
fi
...
runAll() {
# runOne "$HOME/Data/web-Stanford.mtx"
runOne "$HOME/Data/indochina-2004.mtx"
runOne "$HOME/Data/uk-2002.mtx"
runOne "$HOME/Data/arabic-2005.mtx"
runOne "$HOME/Data/uk-2005.mtx"
runOne "$HOME/Data/webbase-2001.mtx"
runOne "$HOME/Data/it-2004.mtx"
runOne "$HOME/Data/sk-2005.mtx"
runOne "$HOME/Data/com-LiveJournal.mtx"
runOne "$HOME/Data/com-Orkut.mtx"
runOne "$HOME/Data/asia_osm.mtx"
runOne "$HOME/Data/europe_osm.mtx"
runOne "$HOME/Data/kmer_A2a.mtx"
runOne "$HOME/Data/kmer_V1r.mtx"
}
